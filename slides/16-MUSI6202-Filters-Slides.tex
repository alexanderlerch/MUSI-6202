...
\section{z-transform}
	...
	\begin{frame}{filters}{example 1 revisited}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
	        \begin{figure}
	...
	\begin{frame}{filters}{example 1 revisited: zplane}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
            \begin{eqnarray*}
        ...
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-LP_FIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
	\end{frame}	
    
	\begin{frame}{filters}{example 2 revisited}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
	        \begin{figure}
	...
	\begin{frame}{filters}{example 2 revisited: zplane}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
            \begin{eqnarray*}
        ...
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-HP_FIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
	...
	\begin{frame}{filters}{example 3 revisited}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
	        \begin{figure}
	...
	\begin{frame}{filters}{example 3 revisited: zplane}
        ...
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-CB_FIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
	...
	\begin{frame}{filters}{example 4 revisited}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
	        \begin{figure}
	...
	\begin{frame}{filters}{example 4 revisited: zplane}
        ...
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-MA_FIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
	...
	\begin{frame}{filters}{example 5 revisited: zplane}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
            \begin{eqnarray*}
                H(z) &=& \frac{1-\alpha}{1-\alpha x^{-1}}\\
               \bigskip
                \pause
            \Rightarrow&&\\
            H(0) &=& 0\\
        ...
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-LP_IIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
	\end{frame}	     
	\begin{frame}{filters}{example 6 revisited}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
	        \begin{figure}
	...
	\begin{frame}{filters}{example 6 revisited: zplane}
        \vspace{-5mm}
        \begin{columns}
        \column{.4\linewidth}
            \begin{eqnarray*}
                H(z) &=& \frac{b_0}{1-a_N x^{-N}}\\
               \bigskip
                \pause
            \Rightarrow&&\\
            H(0) &=& 0\\
            H(z) &=& \infty\text{ for }\omega = \pi-\frac{\pi}{N}, \omega = \pi-\frac{2\pi}{N}, \omega = \pi, |z| < 1
            \end{eqnarray*}
        \column{.6\linewidth}
            \only<2->{
            \begin{figure}
                \centerline{\includegraphics[scale=.8]{SimpleFilterZplane-CB_IIR}}
            \end{figure}
            \addreference{matlab source: \href{https://github.com/alexanderlerch/MUSI-6202/blob/main/matlab/plotSimpleFilterZplane.m}{plotSimpleFilterZplane.m}}
            }
        \end{columns}
