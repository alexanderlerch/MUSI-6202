...
\begin{document}
    ...
    \section{delay line}
		...
		\begin{frame}{modulated effects}{ring buffer: introduction}
            \begin{columns}
            \column{.7\linewidth}
			\begin{itemize}
            ...
            \column{.3\linewidth}
                ...
                \end{figure}
                \addreference{from \href{https://github.com/lamarrr/RingBuffer}{github.com/lamarrr/RingBuffer}}
            \end{columns}
		\end{frame}

		\begin{frame}{modulated effects}{ring buffer: implementation}
            \begin{itemize}
				\item	\textbf{implementation}
					\begin{itemize}
						\item	allocated buffer length $L$ bigger than (maximum) delay $M$: 
                            \[L\geq M\]
						\item	remember current indices: write index $n_\mathrm{w}$ and read index $n_\mathrm{r}$
					\end{itemize}
		...
		\begin{frame}{modulated effects}{ring buffer: discussion}
            \begin{itemize}
			...
			\begin{itemize}
				...
				\item	\textbf{solution}
					\begin{itemize}
						\item	interpolate
							\begin{itemize}
								\item	\only<3>{\textcolor{gtgold}}{linear} interpolation
		...
		\begin{frame}{modulated effects}{introduction: fractional delay line 2/4}
			...
			\end{figure}
           \vspace{-2mm}
            \phantom{\footfullcite{dattorro_effect_1997}}
		\end{frame}
    ...
    \section{phaser \& wah-wah}
		\begin{frame}{modulated effects}{modulated effects: phaser}
			...
			\end{itemize}
				\vspace{-7mm}
				\flushright{\includeaudio{svPhaser}}
		\end{frame}
