...
\begin{frame}{dynamics processing}{response curve: limiter}
	\only<1>{
        \figwithmatlab{DynamicsResponseCurve-1}
	}
	\only<2>{
        \figwithmatlab{Dynamics-1}
		%\begin{figure}
			%\centering
...
\begin{frame}{dynamics processing}{response curve: compressor}
	\only<1>{
        \figwithmatlab{DynamicsResponseCurve-2}
	}
	\only<2>{
        \figwithmatlab{Dynamics-2}
...
\begin{frame}{dynamics processing}{response curve: expander}
	\only<1>{
        \figwithmatlab{DynamicsResponseCurve-3}
	}
	\only<2>{
        \figwithmatlab{Dynamics-3}
...
\begin{frame}{dynamics processing}{response curve: noise gate}
	\only<1>{
        \figwithmatlab{DynamicsResponseCurve-4}
	}
	\only<2>{
        \figwithmatlab{Dynamics-4}
